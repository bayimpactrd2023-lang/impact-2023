...
export const ResearchBayanihanSection: React.FC = React.memo(() => {
  ...
  return (
    <section id="research-bayanihan" className="py-24 relative overflow-hidden"
      style={{
        background: 'linear-gradient(135deg, rgba(248,250,252,1) 0%, rgba(255,255,255,0.98) 50%, rgba(248,250,252,1) 100%)'
      }}
    >
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="card-futuristic p-8">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                <span className="font-bold text-[#1887FC] text-xl">ResearchBayanihan</span> is a groundbreaking initiative that brings together communities, researchers, and stakeholders to co-create sustainable solutions for agricultural development and community empowerment.
              </p>
            ...
            {highlights.map((highlight, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="card-futuristic p-6 group hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#1887FC] to-[#3b82f6] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <Icon className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex-grow">
                      <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#1887FC] transition-colors">
                        {highlight.title}
                      </h3>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-[#1887FC] via-[#3b82f6] to-[#60a5fa] text-white rounded-2xl font-bold text-lg overflow-hidden shadow-2xl hover:shadow-blue-500/50 transition-all duration-500"
          >
